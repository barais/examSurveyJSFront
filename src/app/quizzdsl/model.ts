export class Text {
  ...
  export type Sentence = Text | Radio | Dropdown | Checkboxes | ImagePicker |BooleanEntry | 
...
//Pattern matching on model
 ...
 export type SentenceType = Sentence["type"]
  export type SentenceMap<U> = { [K in SentenceType]: U extends { type: K } ? U : never }
  export type SentenceTypeMap = SentenceMap<Sentence>
  export type Pattern<T> = { [K in keyof SentenceTypeMap]: (shape: SentenceTypeMap[K]) => T }
